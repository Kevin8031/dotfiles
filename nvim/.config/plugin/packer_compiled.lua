...
_G.packer_plugins = {
  ...
  ["lsp-trouble.nvim"] = {
    loaded = true,
    path = "/home/kevin/.local/share/nvim/site/pack/packer/start/lsp-trouble.nvim",
  ...
  ["toggle-lsp-diagnostics.nvim"] = {
    loaded = true,
    path = "/home/kevin/.local/share/nvim/site/pack/packer/start/toggle-lsp-diagnostics.nvim",
